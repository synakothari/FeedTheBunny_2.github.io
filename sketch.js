...
function setup() 
{
  ...
  button.mouseClicked(drop);
   ...
   blower.position(230,300);
   blower.size(110,110);
   blower.mouseClicked(airBlow);
 
   rope = new Rope(8,{x:100,y:90});
   rope2 = new Rope(8,{x:438,y:90});
  ...
  bunny = createSprite(210,height-79,100,100);
  bunny.scale = 0.2;

  star1 = createSprite(270,50,100,100);
  star1.addImage(star_img)
  star1.scale = 0.02;

  star2 = createSprite(50,350,100,100);
  star2.addImage(star_img)
  star2.scale = 0.02;

  //star_display
  star_display = createSprite(50,30,30,30);
...
function draw() 
{
  ...
  //distance b/w star1 and fruit
  if(collide(fruit,star1,30)==true)
  {
    star1.visible=false;
    star_display.changeAnimation('one')
  }
  //distance b/w star2 and fruit
